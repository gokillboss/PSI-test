...
const createNailExam = async () => {
  try {
    ...
    const nailQuestions = [
      ...
      {
        questionText:
          "Để ngăn không bị tách sơn ra từng lớp quý vị nên sử dụng:",
        options: [
      ...
      {
        questionText:
          "Tất cả các dụng cụ đã được khử trùng, phải được bảo quản?",
        options: [
          {
      ...
      {
        questionText:
          "Bảng chỉ dẫn sử dụng an toàn hoá chất SDS dùng trong salon:",
        options: [
          {
      ...
      },
      {
        ...
        options: [
          ...
          {
            text: "Chỉ ngâm phần đầu tiếp xúc với khách hàng",
            isCorrect: false,
          },
      ...
      },
      {
        ...
        options: [
          ...
          {
            text: "Đẩy phần da viền quanh móng ngược trở lại",
            isCorrect: true,
          },
          {
      ...
      {
        questionText:
          "Cần làm gì loại bỏ vi khuẩn phát sinh trước khi khử trùng?",
        options: [
          { text: "Làm sạch", isCorrect: true },
      ...
      },
      {
        ...
        options: [
          ...
          {
            text: "Khử trùng các dụng cụ như trong bệnh viện",
            isCorrect: true,
          },
      ...
      {
        questionText:
          "Sau khi làm sạch bước tiếp theo kiểm soát lây nhiễm là gì?",
        options: [
          { text: "Khử trùng", isCorrect: false },
...

      {
        ...
        options: [
          ...
          {
            text: "Ngâm móng tay trong dung dịch kháng khuẩn",
            isCorrect: false,
          },
        ],
        category: 1,
      },
      {
        ...
        options: [
          {
            text: "Làm theo quy trình dành cho sự cố phơi nhiễm",
            isCorrect: true,
          },
      ...
      },
      {
        ...
        options: [
          ...
          {
            text: "Tạo cảm giác không thoải mái khi massage",
            isCorrect: false,
          },
      ...
      {
        questionText:
          "Mục đích cắt đầu móng trong quá trình làm móng tay cơ bản",
        options: [
      ...
      {
        questionText:
          "Điều gì làm thay đổi hình dạng hoặc độ dày của lớp sừng?",
        options: [
          {
            text: "Sử dụng chất làm cứng móng, chất bổ Keratin",
            isCorrect: false,
          },
      ...
      },
      {
        ...
        options: [
          ...
          {
            text: "Gắn kín khu vực đó để ngăn ngừa vi sinh vật",
            isCorrect: true,
          },
      ...
      {
        questionText:
          "Một khách hàng muốn gỡ bỏ móng giả nhân viên nên làm gì?",
        options: [
          {
      ...
      },
      {
        ...
        options: [
          ...
          {
            text: "Máy dũa được thay đổi giữa các khách hàng",
            isCorrect: false,
          },
        ],
        category: 1,
      ...
      {
        questionText:
          "Ngăn ngừa móng bị tách lớp, bong ra từng lớp nên sử dụng:",
        options: [
          { text: "Sơn móng dạng lỏng khô nhanh", isCorrect: false },
      ...
      },
      {
        ...
        options: [
          ...
          {
            text: "Dũa hết đường lằn, tiến hành chăm sóc móng",
            isCorrect: true,
          },
          {
      ...
      {
        questionText:
          "Ứng xử đúng mức và sự kết hợp đạo đức là phát triển của:",
        options: [
      ...
      {
        questionText:
          "Kỹ thuật nhấn trong massage cần thực hiện theo hướng nào?",
        options: [
      ...
      },
      {
        ...
        options: [
          ...
          {
            text: "Than hoạt tính được sử dụng để thông khí",
            isCorrect: false,
          },
        ],
        category: 1,
      },
      {
        ...
        options: [
          {
            text: "Loại bỏ mùi hôi khiến khách hàng tránh xa",
            isCorrect: false,
          },
    ...
    await Quiz.findByIdAndUpdate(nailExamQuiz._id, {
