    ...
    try {
        ...
        const nailQuestions = [
            ...
            },
            {
                ...
                options: [
                    { text: 'Bảo quản trong 1 thùng chứa sạch có nắp đậy khi không sử dụng', isCorrect: true },
        ...
        
            {
                ...
                options: [
                    { text: 'Quy định việc sử dụng sản phẩm ở các cửa hàng và salon', isCorrect: false },
                    { text: 'Cung cấp thông tin về thành phần sản phẩm và mối nguy hiểm', isCorrect: false },
                    { text: 'Cung cấp thông tin về các hành động cần thực hiện nếu phơi nhiễm với máu hay theo sự cố chảy máu', isCorrect: false },
            ...
            },
            {
                ...
                options: [
                    ...
                    { text: 'Vào cuối ngày làm việc ( hay vào cuối mỗi ngày)', isCorrect: false },
            ...
            },
            {
                ...
                options: [
                    ...
                    { text: 'Chuẩn bị 1 lượng nhỏ dung dịch và thay dung dịch hàng năm', isCorrect: false },
            ...
            },
            {
                ...
                options: [
                    { text: 'Cơ quan quản lý an toàn sức khoẻ nghề nghiệp', isCorrect: false },
            ...
            },
            {
                ...
                options: [
                    ...
                    { text: 'Khiến móng tay chắc và mịn sau khi làm dịch vụ', isCorrect: false },
                    { text: 'Không ảnh hưởng đến việc cắt móng hoặc móng tay', isCorrect: false },
            ...
            },
            {
                ...
                options: [
                    ...
                    { text: 'Phần da ở phía ngay dưới đầu móng Hyponychium', isCorrect: true },
            ...
            },
            {
                ...
                options: [
                    { text: 'Chỉ nên sử dụng sơn lót có màn bọc móng chứ không phải là liquid', isCorrect: false },
            ...
            },
            {
                ...
                options: [
                    ...
                    { text: 'Chỉ nên sử dụng sơn móng với màn bọc chứ không phải là Liquid', isCorrect: false },
            ...
            },
            {
                ...
                options: [
                    { text: 'Để lớp sừng ẩm ướt trước khi gắn móng tay giả', isCorrect: false },
                    { text: 'Để tăng độ mềm dẻo cho móng và làm mềm cho da', isCorrect: true },
                    { text: 'Để làm cho da mềm mại và để màu da được sắc bén', isCorrect: false },
            ...
            },
            {
                ...
                options: [
                    { text: 'Dùng dụng cụ bấm móng để gỡ bỏ móng giả khỏi nền móng', isCorrect: false },
                    { text: 'Đầu móng giả ngâm dung dịch Acetone kéo vuốt trượt ra', isCorrect: true },
            ...
            },
            {
                ...
                options: [
                    { text: 'Các mũi dũa quay tròn hoàn hảo không bị lung lay', isCorrect: true },
                    { text: 'Máy dũa được bảo quản nơi ít ánh sáng, mát mẻ trong salon', isCorrect: false },
            ...
            //////////////////////////  
            {
                questionText: 'Phần móng nào bít kín phần đầu móng cho da bình thường để tránh ẩm, vi khuẩn hay nấm xâm nhập vào trong móng?',
                options: [
            ...
            },
            {
                ...
                options: [
                    { text: 'Loại bỏ lớp bóng bằng chất mài có độ thô ráp trung bình', isCorrect: false },
            ...
            },
            {
                ...
                options: [
                    ...
                    { text: 'Gắn với kích thước đầu móng giả với chất sừng của khách hàng', isCorrect: true },
            ...
            },
            {
                ...
                options: [
                    ...
                    { text: 'Dũa các đường lằn vào phần đầu móng nhưng không phải chăm sóc móng', isCorrect: false },
            ...
            },
            {
                ...
                options: [
                    ...
                    { text: 'Tạo độ cong cho móng để móng không bị bong tróc', isCorrect: false },
            ...
            },
            {
                ...
                options: [
                    ...
                    { text: 'Không được làm bất kỳ dịch vụ nào trong salon', isCorrect: true },
                    { text: 'Được làm dịch vụ nếu khách hàng đeo khẩu trang', isCorrect: false },
        ...
        console.error('Error creating Nail Exam quiz:', err);
        await mongoose.disconnect();
    }
};
