                        ...
                        {!successMessage ? (
                            <Form onSubmit={handleSubmit} className="needs-validation">
                                <Form.Group controlId="formEmail" className="mb-3">
                                    <Form.Label className="text-muted">Nhập địa chỉ email của bạn</Form.Label>
                                    <Form.Control
                                        type="email"
                                        value={email}
                            ...
                            <div className="text-center">
                                <Alert variant="success" className="mt-4">
                                    <p>{successMessage}</p>
                                    <p>Vui lòng kiểm tra email <strong>{maskedEmail}</strong> để đặt lại mật khẩu.</p>
                                    <p>Nếu bạn không nhận được email, hãy kiểm tra thư mục spam hoặc thử gửi lại sau.</p>
                                </Alert>
